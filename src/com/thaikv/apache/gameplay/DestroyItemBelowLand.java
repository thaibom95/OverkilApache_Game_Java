...
/**
 * This class creates a blast effect in the land.
 */
public class DestroyItemBelowLand {
    ...
    public DestroyItemBelowLand(int x, int y) {
        this.x = x;
        this.y = y;
        initDestroyItemBelowLand();
    }

    private void initDestroyItemBelowLand() {
    ...
    public boolean isChangedImageOrDestroy() {
        if (count < 10) {
    ...
    public void drawDestroyItemBelowLand(Graphics2D g) {
